...
#FWQ_203 = ['AB', 'CD']  # 203机房服务器名
# FWQ_203 = ['JK']  # 203机房服务器名
...
#KT_toFwq_list_203 = [['7', '13'], ['6', '11', '12']]  # 203不向前补0,因为JSON数据导出没有补
# KT_toFwq_list_203 = [['1', '2', '8']]  # 203不向前补0,因为JSON数据导出没有补
...
def clean_data(data):
    ...
    data['diff_time'] = data['diff_time'].shift(-1) #shift后，某条数据的diff_time表示该数据与后一行的间隔
